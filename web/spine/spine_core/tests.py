...
from spine_core.models import Project, Repo, File, Asset, AssetType, Task, TaskType
...
class Login_and_Logout_Tests(TestCase):
    ...
    def test_login_with_correct_password(self):
        ...
        self.assertTemplateUsed(response, 'spine_core/list/project.html')
...
class List_and_Detail_View_Tests(TestCase):
    ...
    def test_repo_list_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'spine_core/list/repo.html')
    ...
    def test_file_list_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'spine_core/list/file.html')
    ...
    def test_asset_list_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'spine_core/list/asset.html')
    ...
    def test_task_list_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'spine_core/list/task.html')
    ...
    def test_project_detail_page_with_associated_user(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'spine_core/detail/project.html')
    ...
    def test_repo_detail_page_with_associated_user(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'spine_core/detail/repo.html')
    ...
    def test_file_detail_page_with_associated_user(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'spine_core/detail/file.html')
    ...
    def test_asset_detail_page_with_associated_user(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'spine_core/detail/asset.html')
    ...
    def test_task_detail_page_with_associated_user(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'spine_core/detail/task.html')
